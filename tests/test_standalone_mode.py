...
""")
    ...
    try:
        ...
        cmd = [
            ...
            "--mode", "standalone",
            script_path, "5", 'print(f"x={x}, y={y}, z={z}")'
        ]
...
""")
    ...
    try:
        cmd = [
            sys.executable, "-m", "smart_debugger",
            "--mode", "standalone",
            script_path, "4", 'print(f"argv={sys.argv}")',
            "--", "10", "20", "30"
        ]
...
""")
    ...
    try:
        cmd = [
            sys.executable, "-m", "smart_debugger",
            "--mode", "standalone",
            script_path, "6", 'print(f"json module: {json.__name__}")'
        ]
...
""")
    ...
    try:
        cmd = [
            sys.executable, "-m", "smart_debugger",
            "--mode", "standalone",
            script_path, "4", 'print(f"About to divide by {y}")'
        ]
...
""")
    ...
    try:
        cmd = [
            sys.executable, "-m", "smart_debugger",
            "--mode", "standalone",
            script_path, "3", 'print("This should not execute")'
        ]
...
""")
    ...
    try:
        cmd = [
            sys.executable, "-m", "smart_debugger",
            "--mode", "standalone",
            script_path, "4", 'print(f"__name__={__name__}")'
        ]
